...
default["tomcat"]["use_ssl"] = false
default["tomcat"]["max_threads"] = 150
default["tomcat"]["accept_count"] = 100
default["tomcat"]["connection_timeout"] = 60000
...
default["tomcat"]["ssl_key"] = ENV['TOMCAT_SSL_KEY']
default["tomcat"]["ssl_cert"] = ENV['TOMCAT_SSL_CERT']

default["tomcat"]["jmx"]["enable"] = false
default["tomcat"]["jmx"]["port"] = 11223
default["tomcat"]["jmx"]["ssl"] = false
default["tomcat"]["jmx"]["authenticate"] = false
